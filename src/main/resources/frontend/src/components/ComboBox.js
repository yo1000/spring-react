    ...
    <div className="relative">
      <Combobox as={Fragment} value={selectedItem ?? {value: '', label: ''}} onChange={(item) => {setSelectedItem(item); onChangeItem && onChangeItem(item)}}>
        ...
        {filteredItems.length > 0 && (
          <Combobox.Options className="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
